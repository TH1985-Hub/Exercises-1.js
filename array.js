...
//   function sortUsersByFirstName(customersSalary){
//       return customersSalary.sort((a,b) => a.name.first.localeCompare(b.name.first));

//   } 
//   const userSorted = sortUsersByFirstName(customersSalary);
//   userSorted.forEach(user => {
//     console.log(`First Name: ${user.name.first}, Last Name: ${user.name.last}`);
// });
     
//  console.log("Sorted Users by First Name:", userSorted);


//  function calculateTotalSalaryOfAllUsers(customersSalary){
//     return customersSalary.reduce((acc, user) => acc + parseFloat(user.salary), 0);
//  }
//  const totalSalary = calculateTotalSalaryOfAllUsers(customersSalary);
//  console.log("Total Salary of all Users:", totalSalary);

//  function filterUsersByFriendCount(customersSalary){
//     return customersSalary.filter(user =>user.friends.length >= 8);
//  }
//  const filteredUsers = filterUsersByFriendCount(customersSalary);
//  console.log("Users with 8 or more friends", filteredUsers);//0


//  function mapAllFriends(customersSalary){
//     return customersSalary.map(user => user.friends.map(friend => friend.name));

//  }

//  const allFriends = mapAllFriends(customersSalary);
//  console.log("All Friends:", allFriends);

//  function mapUsers(customersSalary){
//     return customersSalary.map(user => ({
//            _id: user._id,
...
//  const mappedUsers = mapUsers(customersSalary);
...
// function userSortedByFirstname(users){
...
//   console.log(userSortedByFirstname(userSorted));


//   function mappedUsers(userSorted){
//     return userSorted.map(user => {
//         return {
//         _id: user._id,
...
//   }
//   console.log(mappedUsers(userSorted));
...
// const userSorted = filterUser.sort((a, b) => a.name.first.localeCompare(b.name.first));
// userSorted.forEach(user => {
//   console.log(`${user.name.first} ${user.name.last}`);
// });


// const customersSalary = filterUser.reduce((total,user) =>{
//   const balance = parseFloat(user.balance.split('$').join('').split(',').join(''));
//   return total + balance;
// }, 0);

// console.log(`Total Balance: $${customersSalary.toFixed(2)}`);


// function filteredUsersByAllFriends(filterUser){
//   return filterUser.filter(user => user.friends.length >= 8 );
// }

// console.log(filteredUsersByAllFriends(filterUser));


// function mapAllFriends(filterUser) {

//   return filterUser.map(user => user.friends);
  
// }
// console.log(mapAllFriends(filterUser));

// function mappedUsers(filterUser){
...
// console.log (mappedUsers(filterUser));
...
function userSorted(mappedUsers){
  const sortedUsers =  mappedUsers.sort((a,b) => a.name.first.localeCompare(b.name.first));
  const names = sortedUsers.map(user => user.name.first +  " " + user.name.last);
  ...
  console.log(userSorted(mappedUsers));


  function customersBalance(mappedUsers){
    const totalBalance = mappedUsers.reduce((sum, user) =>{
     const balance = parseFloat(user.balance.replace(/[$,]/g, ''));
     return sum + balance;
    }, 0);
    return totalBalance;
  }
   console.log( customersBalance(mappedUsers));


   function filteredUsersByAllFriends(mappedUsers){

    return mappedUsers.filter(user => user.friends.length >= 8 );
  

   }

   console.log(filteredUsersByAllFriends(mappedUsers));
   

function mappedAllUsers(mappedUsers){
  return mappedUsers.map(user => user.friends);
}

console.log(mappedAllUsers(mappedUsers));


function mapAllFriends(mappedUsers){
...
console.log(mapAllFriends(mappedUsers));
